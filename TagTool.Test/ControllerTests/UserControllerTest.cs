...
namespace TagTool.Test
{
    public class UserControllerTest
    {
        ...
        */
        ...
        [Fact]
        public void UserController_SettingsVerify_ReturnsView()
        {
            // When
            var Result = _Controller.SettingsVerify();
        ...
        [Fact]
        public void UserController_SettingsVerify_ServiceCalled()
        {
            // Given
            var LVM = new LoginUserViewModel()
            {
            ...
            // When
            var Page = _Controller.SettingsVerify(LVM);
        ...
        [Fact]
        public void UserController_SettingsVerify_SuccessRedirect()
        {
            // Given
            var LVM = new LoginUserViewModel()
            {
            ...
            var Result = (RedirectToActionResult) _Controller.SettingsVerify(LVM);
            var RouteValue = (Object[]) Result.RouteValues.Values;
            
            // Then 
            Assert.Equal("User", Result.ControllerName);
            Assert.Equal("UserSettings", Result.ActionName);
            Assert.Equal("X", RouteValue[0].ToString()); 

        }

        [Fact]
        public void UserController_SettingsVerify_FailureRedirect()
        {
            // Given
            var LVM = new LoginUserViewModel()
            {
            ...
            // When
            var Page = _Controller.SettingsVerify(LVM) as ViewResult;
            LoginUserViewModel ReturnVM = (LoginUserViewModel) Page.ViewData.Model;

            // Then
            Assert.Equal(LVM, ReturnVM);
        }
    }// Class
}